...
The readiness board cannot raise deployment level automatically. Missing critical assurance evidence returns MIRAGE to Shadow Mode or insufficient-evidence status.
