...
Federation remains local-first. Sites retain local Action Masks, Safety Gates, formal verification, governance, rollback, and audit controls. Cross-site data is denied by default and only pseudonymized summary classes are eligible.
