...
class MIRAGEEvaluator:
    ...
    def _get_reward_interventions_for_method(
        ...
        """
        from mirage.layer3_deception.deception_fabric import DeceptionFabric
        from mirage.layer2_graph_engine.mdp_solver import rank_action_candidates
    ...
    def run_scaling_benchmark(
        ...
        from mirage.layer3_deception.deception_fabric import DeceptionFabric
        from mirage.layer4_decision.decision_engine import RobustDecisionEngine
        from mirage.layer2_graph_engine.mdp_solver import prune_action_space, rank_action_candidates
