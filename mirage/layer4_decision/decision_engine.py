...
from mirage.layer2_graph_engine.mdp_solver import (
    MDPSolver,
...
class RobustDecisionEngine:
    ...
    def _evaluate_portfolio(
        ...
        if len(self.graph.states) > 120:
            from mirage.layer2_graph_engine.mdp_solver import build_hierarchical_subgraph, prune_action_space
    ...
    def optimize_portfolio(
        ...
        if len(self.graph.states) > 30:
            from mirage.layer2_graph_engine.mdp_solver import prune_action_space
